...
public class Game_Controller : MonoBehaviour
{
    ...
    */
    ...
    public int BattlePhaseKey = 0; //0:まだ動いてない 1:動いてアタック待ち 2:攻撃完了
    ...
    void Start()
    {
        ...
        turnControll = RandomTurn;
        NowPlayerTurnText.text = (turnControll + 1) + "P";
        BlindNowPlayerTurnText.text = (turnControll + 1) + "P";
    ...
    void Update()
    {
        ...
        if (PhaseControll == 0) {
            ...
            if (turnControll == 0)
            {
                if (ComeraControllFlag == 0 && HomeCreateFlag[0,0] == 0) {
                    ...
                    FirstPlayer_SetPosition[5, 0] = 1;
                    FirstPlayer_SetPosition[5, 1] = value;
                    FirstPlayer_SetPosition[5, 2] = -4;
                }
                PreparPhase(ref FirstPlayer_SetPosition);
            }
            else
            {
                if (ComeraControllFlag == 0 && HomeCreateFlag[1, 0] == 0)
                {
                    ...
                    SecondPlayer_SetPosition[5, 0] = 1;
                    SecondPlayer_SetPosition[5, 1] = value;
                    SecondPlayer_SetPosition[5, 2] = 4;
                }
                PreparPhase(ref SecondPlayer_SetPosition);
            }

            if (((FirstPlayer_SetPosition[0, 0] == 2) &&
                (FirstPlayer_SetPosition[1, 0] == 2) &&
                (FirstPlayer_SetPosition[2, 0] == 2) &&
                (FirstPlayer_SetPosition[3, 0] == 2) &&
                (FirstPlayer_SetPosition[4, 0] == 2))
                &&
                ((SecondPlayer_SetPosition[0, 0] == 2) &&
                (SecondPlayer_SetPosition[1, 0] == 2) &&
                (SecondPlayer_SetPosition[2, 0] == 2) &&
                (SecondPlayer_SetPosition[3, 0] == 2) &&
                (SecondPlayer_SetPosition[4, 0] == 2))
                )
            {
                PhaseControll = 1;
            ...
            else if ((FirstPlayer_SetPosition[0, 0] == 1) &&
                (FirstPlayer_SetPosition[1, 0] == 1) &&
                (FirstPlayer_SetPosition[2, 0] == 1) &&
                (FirstPlayer_SetPosition[3, 0] == 1) &&
                (FirstPlayer_SetPosition[4, 0] == 1))
            {
                for (int i = 0; i < 6; i++)
                {
                    FirstPlayer_SetPosition[i, 0] = 2;
                    PlayerBattleObject[0, i].SetActive(false);
                }
                TurnController();
            }
            else if ((SecondPlayer_SetPosition[0, 0] == 1) &&
                (SecondPlayer_SetPosition[1, 0] == 1) &&
                (SecondPlayer_SetPosition[2, 0] == 1) &&
                (SecondPlayer_SetPosition[3, 0] == 1) &&
                (SecondPlayer_SetPosition[4, 0] == 1))
            {
                for (int i = 0; i < 6; i++)
                {
                    SecondPlayer_SetPosition[i, 0] = 2;
                    PlayerBattleObject[1, i].SetActive(false);
                }
                TurnController();
            }
        }
        else if(PhaseControll == 1)
        {
            ...
            {
                ComeraControllFlag = 1;
                SkillIconMaster.SetActive(false);
                SkillIconOne.transform.parent.gameObject.SetActive(false);
                SkillIconTwo.transform.parent.gameObject.SetActive(false);
                SkillIconThree.transform.parent.gameObject.SetActive(false);
                BlindPicture.SetActive(true);
                HelthColorChange();
    ...
    void SetFigure(ref float[,] SetPosition, GameObject Name, int Num)
    {
        ...
        else
        {
            ...
            if (turnControll == 0)
            {
                RoleSetting(DeckSelectScript.FirstPlayerDeck);
            }
            else
            {
                RoleSetting(DeckSelectScript.SecondPlayerDeck);
            }
    ...
    void BattleEnd(int NowPlayer,int EnemyPlayer)
    {
